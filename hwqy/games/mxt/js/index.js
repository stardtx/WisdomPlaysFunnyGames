...
style >
    ...
    html, body {
        background - color: #80D4FF;margin:0; padding:0;width:100%;height:100%; text-align: center}



    # loadicon { margin - top: 250 px; }

        #
        orient { margin - top: 50 px; }
        ...
        body onload = "complete();" >
            ...
            div class = "orient"
        id = "orient"
        style = "display:none" > < p > 请在竖屏情况下使用 < /p></div >
            <
