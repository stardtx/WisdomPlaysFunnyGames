...
game9gdialog.innerHTML = '<header><h2 id="game9gtitle">慧玩趣游</h2></header><section id="game9gcontent"></section><footer><a href="javascript:void(0)" id="game9gleftbtn">取消</a><a href="javascript:void(0)" id="game9grightbtn">确定</a></footer>';
...
game9g.utils.hide = function(id) {
    ...
    // if (window.shareData) {
    //     window.shareData.timeLineLink = "http://play.3gjj.cn/games/djz/index.html";
